...
const en = {
  ...
  bonus: { title: 'Bonus Points', subtitle: 'Claim every day · 100 pts = $3 reward', yourPoints: 'Your Points', progressLabel: 'Progress to next reward', claim: '⚡ Claim +10 Points', claimed: '✓ Claimed!', nextClaim: 'Next claim in', redeem: 'Redeem Rewards', redeemed: 'redeemed so far', needMore: 'more pts to redeem', redeemBtn: 'Redeem pts', key3Day: '3-Day Key', balance3: '$3 Balance', fullAccess: 'Full access key', walletCredit: 'Instant wallet credit', getBalance: '💰 Get $3 Balance', getKey: '🔑 Get 3-Day Key', chooseReward: 'Choose Your Reward', rewardDesc: 'You have earned 100 points! Pick your reward below.' },
