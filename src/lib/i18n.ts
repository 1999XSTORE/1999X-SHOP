...
const en = {
  ...
  dashboard: {
    ...
    // Free 1-day key
    freeKey: 'Free 1-Day Trial Key',
    freeKeyDesc: 'One free key every 48 hours — Internal + Fake Lag',
    freeKeyBtn: 'Get Free 1-Day Key',
    ...
    freeKeyLag: 'Fake Lag (1 Day)',
    freeKeyInternal: 'Internal (1 Day)',
    freeKeyExpiresIn: 'Expires in',
    freeKeyOnePerDay: '1 free set per user every 48 hours',
