...
const ar = {
  ...
  reseller: { title: 'لوحة الموزع', subscription: 'اشتراك الموزع', activeSubscription: 'اشتراك نشط', daysLeft: 'متبقي {{count}} أيام' },
...
const bn = {
  ...
  reseller: { title: 'রিসেলার হাব', subscription: 'রিসেলার সাবস্ক্রিপশন', activeSubscription: 'সক্রিয় সাবস্ক্রিপশন', daysLeft: '{{count}} দিন বাকি' },
...
const th = {
  ...
  reseller: { title: 'ศูนย์รวมตัวแทน', subscription: 'การสมัครสมาชิกตัวแทน', activeSubscription: 'การสมัครสมาชิกที่ใช้งานอยู่', daysLeft: 'เหลือ {{count}} วัน' },
