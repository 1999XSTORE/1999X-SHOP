...
const en = {
  ...
  dashboard: {
    ...
    dailyBonus: 'Daily Bonus', dailyBonusDesc: '+10 pts · resets every 24h',
    claimNow: 'Claim Now', nextClaim: 'Next claim in', until: 'until',
    undetected: 'OB52 Undetected', activeAccount: 'Active Account',
    walletBalance: 'Wallet balance', registeredAccounts: 'Registered accounts',
    activeSessions: 'Active sessions now', livePlayingTitle: 'Live Playing',
    ptsToGo: 'pts to go', redeemable: '🎁 Ready!',
    claimPoints: 'Claim +10 Points', claiming: 'Claiming…',
    onlineStatus: 'Online', offStatus: 'Off', paused: 'Paused',
    trialActive: 'Trial Active — Expires In', viewKeys: 'View My Keys', hideKeys: 'Hide Keys',
    panelActive: 'Panel active for all users', panelStopped: 'Panel stopped',
    stopPanel: 'Stop', resumePanel: 'Resume', unavailable: '🚫 Unavailable',
    tempPaused: 'Temporarily paused by owner',
    every48h: 'Every 48h · Internal + Fake Lag',
    nextIn: 'Next in',
    // Free 1-hour key
  ...
  shop: {
    ...
    buy: 'Buy', insufficientBalance: 'Insufficient Balance', purchaseKey: 'Purchase Key', addBalanceToBuy: 'Add Balance to Buy',
    // PayPal auto
  ...
  reseller: {
    title: 'Reseller Hub', subscription: 'Reseller Subscription',
    activeSubscription: 'Active Subscription', daysLeft: '{{count}} days left',
    overview: 'Overview', customerTxns: 'Customer Txns', paymentSettings: 'Payment Settings',
    totalSales: 'Total Sales', totalFees: 'Total Fees',
    yourReferral: 'Your Referral', shareLink: 'Share your link and earn',
    copyLink: 'Copy Link', saveCode: 'Save Code',
    weeklyFee: 'Weekly Platform Fee', feeDue: 'Fee Due', approvedFee: 'Approved Fee',
    payFee: 'Pay Fee via Binance', recentSales: 'Recent Sales',
    noSales: 'No sales yet — share your link!',
    pending: 'Pending', approved: 'Approved', reject: 'Reject', approve: 'Approve',
    shopName: 'Shop Name', savePayment: 'Save Payment Methods',
    customPrices: 'Custom Panel Prices', customImages: 'Custom Card Images',
    subscriptionPaused: 'Subscription Paused',
    pausedDesc: 'Your reseller subscription has been paused by the owner.',
    monthly: 'Monthly', threeMonth: '3 Months', subscribe: 'Subscribe',
    referralLink: 'Your Referral Link', noTransactions: 'No transactions yet',
    enabledMethod: 'Customers pay your details', disabledMethod: 'Uses owner defaults',
  },
  license: {
...
// ── Arabic ────────────────────────────────────────────────────
const ar = {
  nav: { home:'الرئيسية', license:'الترخيص', chat:'الدردشة', shop:'المتجر', bonus:'المكافآت', status:'الحالة', support:'الدعم', signOut:'خروج', reseller:'الموزع' },
  ...
  dashboard: { welcomeBack:'مرحبًا بعودتك', balance:'الرصيد', activeKeys:'المفاتيح النشطة', approved:'موافق', bonusPoints:'نقاط المكافأة', activeSubscriptions:'الاشتراكات النشطة', noLicense:'لا توجد تراخيص نشطة', noLicenseDesc:'اذهب للمتجر لتفعيل مفتاحك', dailyBonus:'المكافأة اليومية', dailyBonusDesc:'+١٠ نقاط/يوم · ١٠٠ نقطة = مكافأة', claimNow:'احصل الآن', nextClaim:'التالي في', until:'حتى', undetected:'OB52 غير مكتشف', activeAccount:'حساب نشط', walletBalance:'رصيد المحفظة', registeredAccounts:'حسابات مسجلة', activeSessions:'جلسات نشطة الآن', livePlayingTitle:'يلعب الآن', ptsToGo:'نقاط للمكافأة', redeemable:'🎁 جاهز!', claimPoints:'احصل على +١٠ نقاط', claiming:'جارٍ الحصول…', onlineStatus:'متصل', offStatus:'غير متصل', paused:'موقوف', trialActive:'التجربة نشطة', viewKeys:'عرض المفاتيح', hideKeys:'إخفاء المفاتيح', panelActive:'اللوحة نشطة للجميع', panelStopped:'اللوحة متوقفة', stopPanel:'إيقاف', resumePanel:'استئناف', unavailable:'🚫 غير متاح', tempPaused:'موقت من قبل المالك', every48h:'كل ٤٨ ساعة · داخلي + تأخير مزيف', nextIn:'التالي في', freeKey:'مفتاح تجريبي مجاني لساعة', freeKeyDesc:'مفتاح مجاني واحد كل ٢٤ ساعة', freeKeyBtn:'احصل على مفتاح مجاني', freeKeyCooldown:'المفتاح التالي في', freeKeyActive:'مفتاحك المجاني نشط', freeKeyExpired:'انتهى المفتاح المجاني', freeKeyGenerating:'جارٍ إنشاء المفاتيح…', freeKeyClaimed:'تم إنشاء المفاتيح!', freeKeyLag:'تأخير مزيف (١ ساعة)', freeKeyInternal:'داخلي (١ ساعة)', freeKeyExpiresIn:'ينتهي في', freeKeyOnePerDay:'مفتاح واحد لكل مستخدم كل ٢٤ ساعة', freeKeyReveal:'انقر 👁 للكشف' },
  shop: { title:'المتجر', products:'المنتجات', ob52:'OB52 غير مكتشف', availableBalance:'الرصيد المتاح', activeAccountNote:'الإيداعات معتمدة عند الموافقة', addBalance:'إضافة رصيد', buyProducts:'شراء المنتجات', chooseAmount:'اختر مبلغ الإيداع', sendExactly:'أرسل بالضبط', youPayApprox:'تدفع تقريبًا', localCurrencyNote:'سعر الصرف تقريبي.', continue:'متابعة', back:'رجوع', selectMethod:'اختر طريقة الدفع', fillDetails:'أدخل بيانات الدفع', yourEmail:'بريدك الإلكتروني', transactionId:'رقم المعاملة', txnPlaceholder:'الصق رقم المعاملة…', txnDesc:'من إيصال الدفع', screenshot:'لقطة الدفع', uploadProof:'ارفع إثبات', reviewSubmission:'مراجعة طلبك', confirmSubmit:'تأكيد وإرسال', submitting:'جارٍ الإرسال…', submitted:'✅ تم الإرسال!', history:'سجل المعاملات', noTxns:'لا توجد معاملات', approved:'✓ موافق', rejected:'✗ مرفوض', pending:'⏳ انتظار', buy:'شراء', insufficientBalance:'رصيد غير كافٍ', addBalanceToBuy: 'أضف رصيدًا للشراء', paypalAuto:'PayPal — تحقق تلقائي فوري', paypalAutoDesc:'يضاف الرصيد تلقائيًا — لا يلزم رقم معاملة', paypalOpen:'الدفع عبر PayPal', paypalOpened:'تم فتح PayPal', paypalStep1:'أكمل الدفع في نافذة PayPal', paypalStep2:'انقر "لقد دفعت" للتحقق', paypalStep3:'يضاف الرصيد تلقائيًا', iHavePaid:'لقد دفعت — تحقق الآن', verifying:'جارٍ التحقق…', verifySuccess:'🎉 تم إضافة الرصيد!', verifyFailed:'فشل التحقق', confirmPurchase:'تأكيد الشراء', confirmDesc:'راجع طلبك', total:'المجموع', cancel:'إلغاء', confirmBtn:'✅ تأكيد', refundNote:'يُخصم فورًا. يُسترد عند الفشل.', purchaseSuccess:'تم الشراء بنجاح!', keyReady:'ترخيصك جاهز', keysSaved:'المفاتيح في صفحة الترخيص.', done:'تم', scanQr:'امسح رمز QR', zoomQr:'انقر للتكبير', qrSoon:'QR قريبًا', amount:'المبلغ', method:'الطريقة', refresh:'تحديث' },
  wallet: { availableBalance: 'الرصيد المتاح', addFunds: 'إضافة رصيد', buyProducts: 'شراء المنتجات', addBalance: 'إضافة رصيد', products: 'المنتجات', history: 'السجل', totalDeposited: 'إجمالي المودع', transactions: 'المعاملات', choosePlan: 'اختر باقتك', choosePlanDesc: 'اختر لوحة ومدة — سيتم تسليم المفتاح فوراً بعد الشراء', instantKey: 'مفتاح فوري', transactionHistory: 'سجل المعاملات', historySummary: '{{payments}} مدفوعات · {{keys}} مفاتيح مشتراة', loadingTransactions: 'جاري تحميل المعاملات...', noHistory: 'لا يوجد سجل بعد', noHistoryDesc: 'ستظهر المدفوعات والمفاتيح المشتراة هنا', purchasedKeys: 'المفاتيح المشتراة', expires: 'ينتهي', keyCopied: 'تم نسخ مفتاح الترخيص', generatingKey: 'جاري إنشاء مفتاح الترخيص...', keyGenerationFailed: 'فشل إنشاء المفتاح. تم استرداد:', product: 'المنتج', duration: 'المدة', licenseNames: { internal: 'داخلي', fakeLag: 'تأخير مزيف', license: 'ترخيص' }, planLabels: { days3: '٣ أيام', days7: '٧ أيام', days30: '٣٠ يوم', weekly: '٧ أيام', monthly: '٣٠ يوم' }, panels: { internal: { name: 'اللوحة الداخلية', tagline: 'أقصى أداء', description: 'شيت داخلي متقدم بتحكم كامل.', features: ['تصويب تلقائي وكشف أماكن', 'سرعة وبدون ارتداد', 'تحديثات تلقائية', 'OB52 غير مكتشف'] }, combo: { name: 'الباقة المجمعة', tagline: 'أفضل قيمة', description: 'داخلي + تأخير مزيف. التجربة الكاملة لـ 1999X.', features: ['كل شيء في الداخلي', 'كل شيء في التأخير المزيف', 'دعم أولوية', 'أفضل سعر مضمون'] }, lag: { name: 'تأخير مزيف', tagline: 'سيطرة على الشبكة', description: 'مزايا مبنية على التأخير. شتت وسيطر.', features: ['تحكم بمفتاح التأخير', 'معالجة الحزم', 'تأخير قابل للتعديل', 'OB52 غير مكتشف'] } } },
  ...
  reseller: { title: 'لوحة الموزع', subscription: 'اشتراك الموزع', activeSubscription: 'اشتراك نشط', daysLeft: 'متبقي {{count}} أيام', overview: 'نظرة عامة', customerTxns: 'معاملات العملاء', paymentSettings: 'إعدادات الدفع', totalSales: 'إجمالي المبيعات', totalFees: 'إجمالي الرسوم', yourReferral: 'إحالتك', shareLink: 'شارك رابطك واكسب', copyLink: 'نسخ الرابط', saveCode: 'حفظ الكود', weeklyFee: 'رسوم المنصة الأسبوعية', feeDue: 'الرسوم المستحقة', approvedFee: 'الرسوم المعتمدة', payFee: 'دفع الرسوم عبر Binance', recentSales: 'أحدث المبيعات', noSales: 'لا مبيعات بعد', pending: 'قيد الانتظار', approved: 'موافق', reject: 'رفض', approve: 'موافقة', shopName: 'اسم المتجر', savePayment: 'حفظ طرق الدفع', subscriptionPaused: 'الاشتراك موقوف', pausedDesc: 'تم إيقاف اشتراكك من قبل المالك.', noTransactions: 'لا توجد معاملات بعد' },
...
// ── Bengali ───────────────────────────────────────────────────
const bn = {
  nav: { home:'হোম', license:'লাইসেন্স', chat:'চ্যাট', shop:'শপ', bonus:'বোনাস', status:'স্ট্যাটাস', support:'সাপোর্ট', signOut:'সাইন আউট', reseller:'রিসেলার' },
  ...
  dashboard: { welcomeBack:'স্বাগতম', balance:'ব্যালেন্স', activeKeys:'সক্রিয় কী', approved:'অনুমোদিত', bonusPoints:'বোনাস পয়েন্ট', activeSubscriptions:'সক্রিয় সাবস্ক্রিপশন', noLicense:'কোনো সক্রিয় লাইসেন্স নেই', noLicenseDesc:'শপে যান', dailyBonus:'দৈনিক বোনাস', dailyBonusDesc:'+১০ পয়েন্ট/দিন · ১০০ = পুরস্কার', claimNow:'এখনই নিন', nextClaim:'পরবর্তী', until:'পর্যন্ত', undetected:'OB52 আনডিটেক্টেড', activeAccount:'সক্রিয় অ্যাকাউন্ট', walletBalance:'ওয়ালেট ব্যালেন্স', registeredAccounts:'নিবন্ধিত অ্যাকাউন্ট', activeSessions:'এখন সক্রিয় সেশন', livePlayingTitle:'লাইভ খেলছে', ptsToGo:'পয়েন্ট বাকি', redeemable:'🎁 রেডি!', claimPoints:'+১০ পয়েন্ট নিন', claiming:'নেওয়া হচ্ছে…', onlineStatus:'অনলাইন', offStatus:'অফ', paused:'বিরতি', trialActive:'ট্রায়াল সক্রিয়', viewKeys:'কী দেখুন', hideKeys:'কী লুকান', panelActive:'সবার জন্য প্যানেল সক্রিয়', panelStopped:'প্যানেল বন্ধ', stopPanel:'বন্ধ', resumePanel:'চালু', unavailable:'🚫 অনুপলব্ধ', tempPaused:'মালিক সাময়িকভাবে বন্ধ করেছেন', every48h:'প্রতি ৪৮ ঘণ্টায় · ইন্টার্নাল + ফেক ল্যাগ', nextIn:'পরবর্তী', freeKey:'বিনামূল্যে ১ ঘণ্টার কী', freeKeyDesc:'প্রতি ২৪ ঘণ্টায় একটি বিনামূল্যে কী', freeKeyBtn:'বিনামূল্যে কী নিন', freeKeyCooldown:'পরবর্তী কী', freeKeyActive:'আপনার বিনামূল্যে কী সক্রিয়', freeKeyExpired:'মেয়াদোত্তীর্ণ', freeKeyGenerating:'কী তৈরি হচ্ছে…', freeKeyClaimed:'কী তৈরি হয়েছে!', freeKeyLag:'ফেক ল্যাগ (১ঘণ্টা)', freeKeyInternal:'ইন্টার্নাল (১ঘণ্টা)', freeKeyExpiresIn:'মেয়াদ শেষ', freeKeyOnePerDay:'প্রতি ২৪ ঘণ্টায় ১টি', freeKeyReveal:'👁 ক্লিক করুন' },
  shop: { title:'শপ', products:'পণ্য', ob52:'OB52 আনডিটেক্টেড', availableBalance:'উপলব্ধ ব্যালেন্স', activeAccountNote:'অনুমোদিত জমা যোগ হয়', addBalance:'ব্যালেন্স যোগ', buyProducts:'পণ্য কিনুন', chooseAmount:'পরিমাণ বেছে নিন', sendExactly:'ঠিক এই পরিমাণ', youPayApprox:'আপনি পরিশোধ করবেন', localCurrencyNote:'বিনিময় হার আনুমানিক।', continue:'চালিয়ে যান', back:'পেছনে', selectMethod:'পেমেন্ট পদ্ধতি', fillDetails:'বিবরণ পূরণ', yourEmail:'আপনার ইমেইল', transactionId:'লেনদেন আইডি', txnPlaceholder:'লেনদেন আইডি পেস্ট করুন…', txnDesc:'পেমেন্টের পর প্রাপ্ত', screenshot:'পেমেন্ট স্ক্রিনশট', uploadProof:'প্রমাণ আপলোড', reviewSubmission:'জমা পর্যালোচনা', confirmSubmit:'নিশ্চিত করুন', submitting:'জমা হচ্ছে…', submitted:'✅ জমা হয়েছে!', history:'ইতিহাস', noTxns:'কোনো লেনদেন নেই', approved:'✓ অনুমোদিত', rejected:'✗ প্রত্যাখ্যাত', pending:'⏳ অপেক্ষমান', buy:'কিনুন', insufficientBalance:'অপর্যাপ্ত ব্যালেন্স', addBalanceToBuy: 'কেনার জন্য ব্যালেন্স যোগ করুন', paypalAuto:'PayPal — তাৎক্ষণিক', paypalAutoDesc:'পেমেন্টের পর স্বয়ংক্রিয়', paypalOpen:'PayPal দিয়ে দিন', paypalOpened:'PayPal খোলা হয়েছে', paypalStep1:'PayPal-এ পেমেন্ট করুন', paypalStep2:'"পেমেন্ট করেছি" ক্লিক করুন', paypalStep3:'স্বয়ংক্রিয়ভাবে যোগ হবে', iHavePaid:'পেমেন্ট করেছি — যাচাই করুন', verifying:'যাচাই হচ্ছে…', verifySuccess:'🎉 ব্যালেন্স যোগ হয়েছে!', verifyFailed:'যাচাই ব্যর্থ', confirmPurchase:'কেনা নিশ্চিত করুন', confirmDesc:'অর্ডার পর্যালোচনা', total:'মোট', cancel:'বাতিল', confirmBtn:'✅ নিশ্চিত', refundNote:'অবিলম্বে কাটা হবে।', purchaseSuccess:'কেনা সফল!', keyReady:'লাইসেন্স প্রস্তুত', keysSaved:'লাইসেন্স পেজে সংরক্ষিত।', done:'সম্পন্ন', scanQr:'QR স্ক্যান করুন', zoomQr:'বড় করতে ক্লিক', qrSoon:'QR শীঘ্রই', amount:'পরিমাণ', method:'পদ্ধতি', refresh:'রিফ্রেশ' },
  wallet: { availableBalance: 'উপলব্ধ ব্যালেন্স', addFunds: 'তহবিল যোগ করুন', buyProducts: 'পণ্য কিনুন', addBalance: 'ব্যালেন্স যোগ করুন', products: 'পণ্য', history: 'ইতিহাস', totalDeposited: 'মোট জমা', transactions: 'লেনদেন', choosePlan: 'আপনার প্ল্যান বেছে নিন', choosePlanDesc: 'একটি প্যানেল এবং সময়কাল বেছে নিন — কেনার পরপরই কী দেওয়া হবে', instantKey: 'তাৎক্ষণিক কী', transactionHistory: 'লেনদেনের ইতিহাস', historySummary: '{{payments}} পেমেন্ট · {{keys}} কেনা কী', loadingTransactions: 'লেনদেন লোড হচ্ছে...', noHistory: 'এখনও কোনো ইতিহাস নেই', noHistoryDesc: 'পেমেন্ট এবং কেনা কীগুলো এখানে দেখা যাবে', purchasedKeys: 'কেনা কী', expires: 'মেয়াদ শেষ', keyCopied: 'লাইসেন্স কী কপি হয়েছে', generatingKey: 'আপনার লাইসেন্স কী তৈরি হচ্ছে...', keyGenerationFailed: 'কী তৈরি ব্যর্থ হয়েছে। ফেরত দেওয়া হয়েছে:', product: 'পণ্য', duration: 'সময়কাল', licenseNames: { internal: 'ইন্টার্নাল', fakeLag: 'ফেক ল্যাগ', license: 'লাইসেন্স' }, planLabels: { days3: '৩ দিন', days7: '৭ দিন', days30: '৩০ দিন', weekly: '৭ দিন', monthly: '৩০ দিন' }, panels: { internal: { name: 'ইন্টার্নাল প্যানেল', tagline: 'সর্বোচ্চ পারফরম্যান্স', description: 'সম্পূর্ণ নিয়ন্ত্রণ সহ উন্নত ইন্টার্নাল চিট।', features: ['এইমবট ও ইএসপি', 'গতি ও নো রিকয়েল', 'স্বয়ংক্রিয় আপডেট', 'OB52 আনডিটেক্টেড'] }, combo: { name: 'কম্বো প্যাক', tagline: 'সেরা মূল্যের বান্ডেল', description: 'ইন্টার্নাল + ফেক ল্যাগ। সম্পূর্ণ 1999X অভিজ্ঞতা।', features: ['ইন্টার্নালের সবকিছু', 'ফেক ল্যাগের সবকিছু', 'অগ্রাধিকার সাপোর্ট', 'সেরা দামের নিশ্চয়তা'] }, lag: { name: 'ফেক ল্যাগ', tagline: 'নেটওয়ার্ক আধিপত্য', description: 'ল্যাগ-ভিত্তিক সুবিধা। বিভ্রান্ত করুন এবং জয় করুন।', features: ['ল্যাগ সুইচ কন্ট্রোল', 'প্যাকেট ম্যানিপুলেশন', 'সামঞ্জস্যযোগ্য বিলম্ব', 'OB52 আনডিটেক্টেড'] } } },
  ...
  reseller: { title: 'রিসেলার হাব', subscription: 'রিসেলার সাবস্ক্রিপশন', activeSubscription: 'সক্রিয় সাবস্ক্রিপশন', daysLeft: '{{count}} দিন বাকি', overview: 'ওভারভিউ', customerTxns: 'গ্রাহকের লেনদেন', paymentSettings: 'পেমেন্ট সেটিংস', totalSales: 'মোট বিক্রয়', totalFees: 'মোট ফি', yourReferral: 'আপনার রেফারেল', shareLink: 'লিঙ্ক শেয়ার করুন', copyLink: 'লিঙ্ক কপি', saveCode: 'কোড সেভ', weeklyFee: 'সাপ্তাহিক ফি', feeDue: 'বকেয়া ফি', approvedFee: 'অনুমোদিত ফি', payFee: 'Binance দিয়ে ফি দিন', recentSales: 'সাম্প্রতিক বিক্রয়', noSales: 'এখনো কোনো বিক্রয় নেই', pending: 'অপেক্ষমান', approved: 'অনুমোদিত', reject: 'প্রত্যাখ্যান', approve: 'অনুমোদন', shopName: 'শপের নাম', savePayment: 'পেমেন্ট পদ্ধতি সেভ', subscriptionPaused: 'সাবস্ক্রিপশন বিরতি', pausedDesc: 'আপনার রিসেলার সাবস্ক্রিপশন মালিক স্থগিত করেছেন।', noTransactions: 'এখনো কোনো লেনদেন নেই' },
...
// ── Thai ──────────────────────────────────────────────────────
const th = {
  nav: { home:'หน้าแรก', license:'ใบอนุญาต', chat:'แชท', shop:'ร้านค้า', bonus:'โบนัส', status:'สถานะ', support:'สนับสนุน', signOut:'ออกจากระบบ', reseller:'ตัวแทนจำหน่าย' },
  ...
  dashboard: { welcomeBack:'ยินดีต้อนรับกลับ', balance:'ยอดเงิน', activeKeys:'คีย์ที่ใช้งาน', approved:'อนุมัติ', bonusPoints:'คะแนนโบนัส', activeSubscriptions:'การสมัครสมาชิก', noLicense:'ไม่มีใบอนุญาต', noLicenseDesc:'ไปที่ร้านค้า', dailyBonus:'โบนัสรายวัน', dailyBonusDesc:'+10 แต้ม/วัน · 100 แต้ม = รางวัล', claimNow:'รับตอนนี้', nextClaim:'รับครั้งถัดไปใน', until:'ถึง', undetected:'OB52 ไม่ถูกตรวจจับ', activeAccount:'บัญชีใช้งาน', walletBalance:'ยอดกระเป๋า', registeredAccounts:'บัญชีที่ลงทะเบียน', activeSessions:'เซสชันที่ใช้งานอยู่', livePlayingTitle:'กำลังเล่น', ptsToGo:'แต้มเพิ่มเติม', redeemable:'🎁 พร้อมแลก!', claimPoints:'รับ +10 แต้ม', claiming:'กำลังรับ…', onlineStatus:'ออนไลน์', offStatus:'ออฟ', paused:'หยุดชั่วคราว', trialActive:'ทดลองใช้งาน', viewKeys:'ดูคีย์', hideKeys:'ซ่อนคีย์', panelActive:'แผงใช้งานได้สำหรับทุกคน', panelStopped:'แผงหยุดทำงาน', stopPanel:'หยุด', resumePanel:'ดำเนินการต่อ', unavailable:'🚫 ไม่พร้อมใช้งาน', tempPaused:'เจ้าของหยุดชั่วคราว', every48h:'ทุก 48 ชม · Internal + Fake Lag', nextIn:'ถัดไปใน', freeKey:'คีย์ทดลองฟรี 1 ชั่วโมง', freeKeyDesc:'คีย์ฟรีทุก 24 ชั่วโมง', freeKeyBtn:'รับคีย์ฟรี', freeKeyCooldown:'คีย์ถัดไปใน', freeKeyActive:'คีย์ฟรีของคุณใช้งานได้', freeKeyExpired:'คีย์ฟรีหมดอายุ', freeKeyGenerating:'กำลังสร้างคีย์…', freeKeyClaimed:'สร้างคีย์สำเร็จ!', freeKeyLag:'Fake Lag (1ชม)', freeKeyInternal:'Internal (1ชม)', freeKeyExpiresIn:'หมดอายุใน', freeKeyOnePerDay:'1 คีย์ต่อผู้ใช้ทุก 24 ชั่วโมง', freeKeyReveal:'คลิก 👁 เพื่อดู' },
  shop: { ...en.shop, title:'ร้านค้า', products:'สินค้า', ob52:'OB52 ไม่ถูกตรวจจับ', availableBalance:'ยอดเงินที่มี', addBalance:'เติมเงิน', buyProducts:'ซื้อสินค้า', chooseAmount:'เลือกจำนวนเงิน', sendExactly:'ส่งเงินจำนวนนี้', continue:'ดำเนินการต่อ', back:'กลับ', selectMethod:'เลือกวิธีชำระ', fillDetails:'กรอกรายละเอียด', yourEmail:'อีเมลของคุณ', transactionId:'รหัสธุรกรรม', history:'ประวัติ', noTxns:'ไม่มีธุรกรรม', approved:'✓ อนุมัติ', rejected:'✗ ปฏิเสธ', pending:'⏳ รอดำเนินการ', buy:'ซื้อ', insufficientBalance:'ยอดเงินไม่เพียงพอ', addBalanceToBuy:'เพิ่มยอดเงินเพื่อซื้อ', cancel:'ยกเลิก', done:'เสร็จสิ้น', amount:'จำนวน', method:'วิธี', refresh:'รีเฟรช' },
  wallet: { availableBalance: 'ยอดเงินที่ใช้ได้', addFunds: 'เพิ่มเงินทุน', buyProducts: 'ซื้อสินค้า', addBalance: 'เพิ่มยอดเงิน', products: 'สินค้า', history: 'ประวัติ', totalDeposited: 'ฝากรวม', transactions: 'ธุรกรรม', choosePlan: 'เลือกแผนของคุณ', choosePlanDesc: 'เลือกแผงและระยะเวลา — ส่งคีย์ทันทีหลังซื้อ', instantKey: 'คีย์ทันที', transactionHistory: 'ประวัติการทำธุรกรรม', historySummary: '{{payments}} การชำระเงิน · {{keys}} คีย์ที่ซื้อ', loadingTransactions: 'กำลังโหลดธุรกรรม...', noHistory: 'ยังไม่มีประวัติ', noHistoryDesc: 'การชำระเงินและคีย์ที่ซื้อจะแสดงที่นี่', purchasedKeys: 'คีย์ที่ซื้อ', expires: 'หมดอายุ', keyCopied: 'คัดลอกคีย์ใบอนุญาตแล้ว', generatingKey: 'กำลังสร้างคีย์ใบอนุญาตของคุณ...', keyGenerationFailed: 'การสร้างคีย์ล้มเหลว คืนเงินแล้ว:', product: 'สินค้า', duration: 'ระยะเวลา', licenseNames: { internal: 'Internal', fakeLag: 'Fake Lag', license: 'ใบอนุญาต' }, planLabels: { days3: '3 วัน', days7: '7 วัน', days30: '30 วัน', weekly: '7 วัน', monthly: '30 วัน' }, panels: { internal: { name: 'แผง Internal', tagline: 'ประสิทธิภาพสูงสุด', description: 'โปรแกรมช่วยเล่นภายในขั้นสูงพร้อมการควบคุมเต็มรูปแบบ', features: ['Aimbot & ESP', 'ความเร็ว & ไม่มีแรงถีบ', 'อัปเดตอัตโนมัติ', 'OB52 ไม่ถูกตรวจจับ'] }, combo: { name: 'แพ็คเกจ Combo', tagline: 'คุ้มค่าที่สุด', description: 'Internal + Fake Lag ประสบการณ์ 1999X เต็มรูปแบบ', features: ['ทุกอย่างใน Internal', 'ทุกอย่างใน Fake Lag', 'การสนับสนุนระดับวีไอพี', 'รับประกันราคาที่ดีที่สุด'] }, lag: { name: 'Fake Lag', tagline: 'การครอบงำเครือข่าย', description: 'ข้อได้เปรียบตามความล่าช้า สับสนและพิชิต', features: ['ควบคุม Lag switch', 'การจัดการแพ็คเก็ต', 'ความล่าช้าที่ปรับได้', 'OB52 ไม่ถูกตรวจจับ'] } } },
  ...
  reseller: { title: 'ศูนย์รวมตัวแทน', subscription: 'การสมัครสมาชิกตัวแทน', activeSubscription: 'การสมัครสมาชิกที่ใช้งานอยู่', daysLeft: 'เหลือ {{count}} วัน', overview: 'ภาพรวม', customerTxns: 'รายการลูกค้า', paymentSettings: 'ตั้งค่าการชำระเงิน', totalSales: 'ยอดขายรวม', totalFees: 'ค่าธรรมเนียมรวม', yourReferral: 'รหัสแนะนำ', shareLink: 'แชร์ลิงก์ของคุณ', copyLink: 'คัดลอกลิงก์', saveCode: 'บันทึกรหัส', weeklyFee: 'ค่าธรรมเนียมรายสัปดาห์', feeDue: 'ค่าธรรมเนียมที่ค้างชำระ', approvedFee: 'ค่าธรรมเนียมที่อนุมัติ', payFee: 'ชำระค่าธรรมเนียมผ่าน Binance', recentSales: 'ยอดขายล่าสุด', noSales: 'ยังไม่มียอดขาย', pending: 'รอดำเนินการ', approved: 'อนุมัติ', reject: 'ปฏิเสธ', approve: 'อนุมัติ', shopName: 'ชื่อร้าน', savePayment: 'บันทึกวิธีชำระเงิน', subscriptionPaused: 'การสมัครถูกหยุดชั่วคราว', pausedDesc: 'การสมัครตัวแทนของคุณถูกระงับโดยเจ้าของ', noTransactions: 'ยังไม่มีรายการ' },
