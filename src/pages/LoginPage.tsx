      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="rounded-2xl p-8 border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl shadow-black/60 animate-fade-up">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight mb-1">1999X</h1>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            {[
              ...
              { icon: Star,   text: 'OB52 Ready' },
            ].map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-center gap-1 text-[10px] text-white/50">
          ...
          <div className="relative mb-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm text-white hover:bg-white/10 transition-colors"
            >
            ...
            {langOpen && (
              <div className="absolute top-full left-0 right-0 mt-1 max-h-40 overflow-y-auto rounded-xl border border-white/10 bg-[#0f0f1f]/95 backdrop-blur shadow-xl z-50">
                {LANGUAGES.map(lang => (
                  <button
                    key={lang.code}
                    ...
                    className={cn(
                      ...
                      lang.code === i18n.language ? 'text-purple-400 font-semibold' : 'text-white/70'
                    )}
                  >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-4 rounded-xl font-bold text-sm text-white transition-all active:scale-[0.97] disabled:opacity-60 relative overflow-hidden group"
            style={{
